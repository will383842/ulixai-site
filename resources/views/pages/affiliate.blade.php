...
<head>
  ...
  <link rel="alternate" hreflang="de" href="https://ulixai.com/de/affiliate" />
  <link rel="alternate" hreflang="es" href="https://ulixai.com/es/affiliate" />
  <link rel="alternate" hreflang="pt" href="https://ulixai.com/pt/affiliate" />
  <link rel="alternate" hreflang="ar" href="https://ulixai.com/ar/affiliate" />
  <link rel="alternate" hreflang="ru" href="https://ulixai.com/ru/affiliate" />
  ...
  <meta property="og:description" content="Your link, your network, your income. Sign up in 30 seconds, get your link instantly, start earning today!">
  <meta property="og:image" content="https://ulixai.com/images/og-affiliate-en.jpg">
  ...
  <script type="application/ld+json">
  {
    ...
    "description": "Global platform connecting expats with local helpers in 197 countries",
    "foundingDate": "2024",
    "address": {
      "@type": "PostalAddress",
      "addressCountry": "FR"
    ...
    "contactPoint": {
      ...
      "availableLanguage": ["en", "fr", "es", "de", "pt", "ar", "ru", "zh", "hi"]
    }
  }
  </script>
  
  <!-- JSON-LD: WebPage + Breadcrumb PERFECT -->
  <script type="application/ld+json">
  {
    "@context": "https://schema.org",
    "@type": "WebPage",
    "name": "Ulixai Affiliate Program - Earn 75% Commission",
    "description": "Join Ulixai's affiliate program and earn 75% commission. Sign up free, get your link instantly, promote in 197 countries. Start earning today!",
    "url": "https://ulixai.com/en/affiliate",
    "inLanguage": "en",
    "isPartOf": {
      "@type": "WebSite",
      "name": "Ulixai",
    ...
    "breadcrumb": {
      ...
      "itemListElement": [{
        ...
        "item": "https://ulixai.com/en/affiliate"
      }]
    },
    "mainEntity": {
      "@type": "Service",
      "name": "Ulixai Affiliate Program",
      "description": "Earn 75% commission by promoting Ulixai",
      "provider": {
        "@type": "Organization",
        "name": "Ulixai"
      },
  ...
  <script type="application/ld+json">
  {
    ...
    "mainEntity": [{
      "@type": "Question",
      "name": "How do I start earning money with the Ulixai affiliate program?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "It's simple: 1) Sign up for free in 30 seconds, 2) Get your unique affiliate link from your dashboard, 3) Share it on WhatsApp, Facebook, Instagram, or anywhere. As soon as someone signs up via your link and purchases a service, you earn 75% commission on the service fees automatically!"
      }
    },{
      "@type": "Question",
      "name": "What commission rate does Ulixai offer?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You receive 75% commission on service fees for every transaction, paid directly in € or $ depending on your currency. This is one of the most generous rates in the affiliate marketing industry in 2025."
      }
    },{
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You can request a payout as soon as you have $30 or €30 in your account. Payments are made directly to your bank account via wire transfer. Fast, simple, and secure with no hidden fees."
      }
    },{
      "@type": "Question",
      "name": "What countries and languages does Ulixai support?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Ulixai covers 197 countries and all world languages. Whether your contacts speak English, Spanish, Arabic, Chinese, French, or any other language, they can use the platform and you earn your commission!"
      }
    },{
      "@type": "Question",
      "name": "Is there any cost to join the affiliate program?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Absolutely not! Registration is 100% free. You never have to pay anything. All you need is your affiliate link and your contacts. Zero investment, 100% earnings potential."
      }
    }]
  }
  </script>

  <!-- Preload Critical Resources for SPEED -->
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .highlight {
      background: linear-gradient(120deg, rgba(37, 99, 235, 0.15) 0%, rgba(168, 85, 247, 0.15) 100%);
      padding: 3px 8px;
      border-radius: 6px;
      font-weight: 800;
      color: var(--primary);
    ...
    @media (min-width: 640px) {
      .author-avatar {
        ...
        height: 60px;
        font-size: 22px;
        box-shadow: 0 7px 22px rgba(37, 99, 235, 0.25);
      }
    }
...
<body>
  ...
  <!-- 🔥 VIRAL SHARE SYSTEM - 100% ENGLISH -->
      ...
      <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full p-5 sm:p-6 transform transition-all scale-95 opacity-0" id="popupContent">
          ...
          <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-3.5 sm:p-4 mb-3 sm:mb-4 border-2 border-green-200">
              <div class="flex items-center justify-between mb-2">
                  ...
                  <span class="text-xl sm:text-2xl font-bold text-green-600">75%</span>
              </div>
  ...
  <script>
  // VIRAL SHARE SYSTEM - 100% ENGLISH VERSION
  document.addEventListener('DOMContentLoaded', function() {
      ...
      // Viral messages - 100% ENGLISH - AFFILIATE SPECIFIC
      const viralText = encodeURIComponent(`💰 I discovered how to earn 75% commission online!\n\n👉 Join Ulixai's affiliate program:\n\n✅ 100% FREE\n✅ Instant link after signup\n✅ 75% commission on EVERY sale\n✅ 197 countries + all languages\n\n🚀 Share your link and earn money! 💸`);
      const subject = encodeURIComponent("💰 75% Commission - Ulixai Affiliate Program!");
      ...
      // Show popup ONLY after clicking a share button
        ...
        <div class="carousel-wrapper" id="testimonialsCarousel">
          <div class="carousel-item">
            <div class="testimonial-card">
              ...
              <p class="testimonial-text">"I shared my link in 2 WhatsApp expat groups. First earnings in 10 days! Ultra-clear dashboard, regular payments. Top!"</p>
          ...
          <div class="carousel-item">
            <div class="testimonial-card">
              <div class="testimonial-stars">⭐⭐⭐⭐⭐</div>
              <p class="testimonial-text">"My network in the African diaspora allows me to have regular conversions in 6 countries. Commissions in € are excellent 💰"</p>
              <div class="testimonial-author">
          ...
          <div class="carousel-item">
            <div class="testimonial-card">
              <div class="testimonial-stars">⭐⭐⭐⭐⭐</div>
              <p class="testimonial-text">"Complete dashboard: I see everything in real-time (clicks, conversions, earnings). Super-responsive support. I recommend 100%!"</p>
              <div class="testimonial-author">
  ...
  <script>
    ...
    const calculator = {
      ...
      updateResults() {
        ...
        const commissionRate = 0.1125; // 75% of 15% = 11.25%
    ...
    // Animate monthly payout - OPTIMIZED
