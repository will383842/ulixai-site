...
<head>
  ...
  <title>{{ $title }} - Ulixai | Affiliate Program Terms</title>
  <meta name="description" content="Read Ulixai's Affiliate Program Terms & Conditions. Understand commission rates, payment terms, and your responsibilities as an affiliate partner.">
  <meta name="keywords" content="affiliate terms, affiliate agreement, commission terms, affiliate program conditions, Ulixai affiliate">
  <meta name="author" content="Ulixai">
  <meta name="robots" content="index, follow">
  <link rel="canonical" href="{{ route('terms.affiliate') }}" />
  <meta name="theme-color" content="#10B981">

  <meta property="og:type" content="website">
  <meta property="og:url" content="{{ route('terms.affiliate') }}">
  <meta property="og:title" content="{{ $title }} - Ulixai">
  <meta property="og:description" content="Read our Affiliate Program Terms & Conditions to understand commission rates and your responsibilities.">
  <meta property="og:locale" content="en_US">
  <meta property="og:site_name" content="Ulixai">

  <meta name="twitter:card" content="summary">
  <meta name="twitter:title" content="{{ $title }} - Ulixai">
  <meta name="twitter:description" content="Affiliate Program Terms & Conditions for Ulixai.">
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .prose em { font-style: italic; color: var(--success); }
    ...
    .prose a:hover { color: var(--primary); text-decoration: underline; }
    ...
    .terms-nav a:hover { border-color: var(--success); color: var(--success); }
    .terms-nav a.active {
      background: var(--success);
      color: white;
    ...
    <div class="container">
      <div class="hero-content">
        ...
        <p class="hero-subtitle">
          Conditions applicables aux affilies du programme de parrainage Ulixai.
        </p>
  ...
  <section class="content-section">
    <div class="container">
      ...
      <nav class="terms-nav">
        ...
        <a href="{{ route('terms.client') }}">Clients</a>
        <a href="{{ route('terms.provider') }}">Prestataires</a>
        <a href="{{ route('terms.affiliate') }}" class="active">Affiliation</a>
      </nav>
        ...
        <div class="prose">
          ...
          @else
            <div class="empty-state">
              ...
              <p>Les conditions d'affiliation seront bientot disponibles.</p>
            </div>
          @endif
        </div>
      </div>
