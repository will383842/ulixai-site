...
<head>
  ...
  <title>{{ $title }} - Ulixai | Provider Terms of Service</title>
  <meta name="description" content="Read Ulixai's Service Provider Terms & Conditions. Understand your rights, responsibilities, and our policies when offering services on our platform.">
  <meta name="keywords" content="provider terms, service provider agreement, provider rights, Ulixai terms, freelancer terms">
  <meta name="author" content="Ulixai">
  <meta name="robots" content="index, follow">
  <link rel="canonical" href="{{ route('terms.provider') }}" />
  <meta name="theme-color" content="#2563EB">

  <meta property="og:type" content="website">
  <meta property="og:url" content="{{ route('terms.provider') }}">
  <meta property="og:title" content="{{ $title }} - Ulixai">
  <meta property="og:description" content="Read our Provider Terms & Conditions to understand your rights and responsibilities as a service provider.">
  <meta property="og:locale" content="en_US">
  <meta property="og:site_name" content="Ulixai">

  <meta name="twitter:card" content="summary">
  <meta name="twitter:title" content="{{ $title }} - Ulixai">
  <meta name="twitter:description" content="Provider Terms & Conditions for Ulixai platform.">
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .terms-nav a:hover { border-color: var(--accent); color: var(--accent); }
    .terms-nav a.active {
    ...
    <div class="container">
      <div class="hero-content">
        <div class="hero-badge" role="status">
          ...
          <span>Provider Terms</span>
        </div>

        <h1>{{ $title }}</h1>

        <p class="hero-subtitle">
          Conditions applicables aux prestataires de services sur la plateforme Ulixai.
        </p>
  ...
  <section class="content-section">
    <div class="container">
      ...
      <nav class="terms-nav">
        ...
        <a href="{{ route('terms.provider') }}" class="active">Prestataires</a>
        ...
        <div class="prose">
          ...
          @else
            <div class="empty-state">
              ...
              <p>Les conditions prestataires seront bientot disponibles.</p>
            </div>
          @endif
        </div>
      </div>
