...
<head>
  ...
  <style>
    * {
    ...
    /* Enhanced Card Styles - Mobile First */
    .enhanced-card {
      background: white;
      border-radius: 1rem;
      padding: 1rem;
    ...
    @keyframes bounce {
      ...
      40%, 43% { transform: translateY(-6px) translateZ(0); }
    ...
    /* Modal Styles - Mobile First, Wider than Tall on Desktop */
    .modal-backdrop {
      position: fixed;
      inset: 0;
    ...
    /* Press Release Card - Mobile First */
    .press-release-card {
      background: white;
      border-radius: 1rem;
      padding: 1rem;
    ...
    /* English Flag - Visible on All Devices */
    .flag-en {
      display: inline-flex;
      align-items: center;
      justify-content: center;
  ...
  <div id="pdfModal" class="modal-backdrop hidden" style="display: none;" role="dialog" aria-modal="true" aria-labelledby="pdf-modal-title">
    <div class="modal-content">
      ...
      <div style="height: 500px; max-height: 70vh;">
        <iframe id="pdfModalFrame" class="w-full h-full" src="" title="PDF document viewer"></iframe>
      </div>
    </div>
  </div>
