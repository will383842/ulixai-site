...
{{-- ═══════════════════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════════════════ --}}
<nav id="mobile-menu" class="lg:hidden fixed top-[62px] left-0 right-0 bg-white z-50 shadow-2xl rounded-b-3xl transform -translate-y-full transition-transform duration-200 ease-out overflow-y-auto" style="max-height: calc(100dvh - 62px); -webkit-overflow-scrolling: touch;" role="navigation" aria-label="Mobile menu" aria-hidden="true">
