<!-- About You Modal -->
<div id="aboutYouPopup" class="hidden fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 modal-overlay" role="dialog" aria-modal="true" aria-labelledby="about-you-title">
  <div class="bg-white rounded-3xl w-full max-w-2xl shadow-2xl relative transform transition-all modal-content overflow-hidden">
    ...
    <div class="bg-gradient-to-br from-blue-600 to-blue-700 p-6 sm:p-8 text-white relative overflow-hidden">
      ...
      <div class="relative z-10">
        ...
        <h2 id="about-you-title" class="text-2xl sm:text-3xl font-bold mb-2">Parlez-nous de vous</h2>
        <p class="text-blue-100 text-sm">Quelques mots pour faire la différence</p>
      </div>
    </div>
    ...
    <div class="p-6 sm:p-8">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6" role="list">
        <div class="bg-blue-50 rounded-xl p-4 border border-blue-100" role="listitem">
          <div class="flex items-center gap-3">
            ...
            <div class="flex-1 min-w-0">
              <div class="text-xs text-gray-600 mb-0.5">Visibilité</div>
              <div class="text-sm font-semibold text-gray-800">Profil complet</div>
            </div>
          </div>
        </div>
        ...
        <div class="bg-green-50 rounded-xl p-4 border border-green-100" role="listitem">
          <div class="flex items-center gap-3">
            ...
            <div class="flex-1 min-w-0">
              <div class="text-xs text-gray-600 mb-0.5">Confiance</div>
              <div class="text-sm font-semibold text-gray-800">Plus de missions</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- Tips -->
      <aside class="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-4 mb-6 border border-amber-100" role="complementary" aria-label="Conseils de rédaction">
        <div class="flex items-start gap-3">
          ...
          <div class="flex-1 min-w-0">
            <h3 class="text-sm font-semibold text-gray-800 mb-2">Conseils pour une description réussie :</h3>
            <ul class="space-y-1.5 text-xs text-gray-600" role="list">
              <li class="flex items-start gap-2">
                ...
                <span>Présentez votre expérience et vos compétences</span>
              </li>
              <li class="flex items-start gap-2">
                <i class="fas fa-check text-green-600 mt-0.5 flex-shrink-0" aria-hidden="true"></i>
                <span>Expliquez ce qui vous rend unique</span>
              </li>
              <li class="flex items-start gap-2">
                <i class="fas fa-check text-green-600 mt-0.5 flex-shrink-0" aria-hidden="true"></i>
                <span>Soyez authentique et professionnel</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="relative mb-6">
        <label for="aboutYouText" class="block text-sm font-semibold text-gray-700 mb-2">
          Votre présentation <span class="text-red-500" aria-label="requis">*</span>
        </label>
        <div class="relative">
          <textarea 
            id="aboutYouText" 
            ...
            placeholder="Exemple : Bonjour ! Je suis passionné(e) par mon métier depuis plus de 5 ans. J'aime aider les expatriés à s'installer confortablement dans leur nouveau pays. Mon expertise et mon souci du détail font de moi un prestataire de confiance..."></textarea>
...
<style>
/* Modal animations avec prefers-reduced-motion */
...
<script>
// Character counter avec debounce pour performance
...
function submitAboutYou() {
  ...
  // Loading state
  btn.disabled = true;
  btn.innerHTML = '<i class="fas fa-spinner fa-spin mr-2" aria-hidden="true"></i>Enregistrement...';
  
  // Votre logique d'enregistrement ici
  
  // Restaurer l'état après succès/erreur
  setTimeout(() => {
    btn.disabled = false;
    btn.innerHTML = '<i class="fas fa-check" aria-hidden="true"></i>Enregistrer';
  }, 2000);
}
</script>