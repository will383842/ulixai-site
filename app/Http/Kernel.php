...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \Illuminate\Session\Middleware\AuthenticateSession::class, // Enabled: invalidate sessions on password change
        ...
        'api' => [
            \Laravel\Sanctum\Http\Middleware\EnsureFrontendRequestsAreStateful::class, // Enabled: SPA authentication
            'throttle:api',
            \Illuminate\Routing\Middleware\SubstituteBindings::class,
        ],
    ];
    ...
    protected $routeMiddleware = [
        ...
        'provider.active' => \App\Http\Middleware\CheckProviderActive::class,
